...
private int mamau;
    ...
    public ColorDTO(int mamau, String tenmau) {
        this.mamau = mamau;
        this.tenmau = tenmau;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ColorDTO other = (ColorDTO) obj;
    ...
    public String toString() {
        return "ColorDTO{" + "mamau=" + mamau + ", tenmau=" + tenmau + '}';
    }

    public void compareTo(ColorDTO anotherString) {
