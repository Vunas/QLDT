        ...
        try (Connection conn = JdbcUtil.getConnection();
            ...
            try (ResultSet rs = statement.executeQuery()) {
                if (rs.next()) {
                    ...
                    int giaTri = rs.getInt("giatri");
                    int hinhThuc = rs.getInt("hinhthuc");
                    khuyenMaiDTO = new KhuyenMaiDTO(ma, ten, soLuong, start, end, apDung, giaTri, hinhThuc);
                }
            } catch (Exception e) {
                // TODO: handle exception
                e.printStackTrace();
        ...
        try (Connection conn = JdbcUtil.getConnection();
            ...
            ResultSet rs = statement.executeQuery()){
                while (rs.next()) {
                    ...
                    int giaTri = rs.getInt("giatri");
                    int hinhThuc = rs.getInt("hinhthuc");
                    KhuyenMaiDTO khuyenMaiDTO = new KhuyenMaiDTO(maKM, tenKM, soLuong, ngayBD, ngayKT, apDungChoHoaDonTu, giaTri, hinhThuc);
                    list.add(khuyenMaiDTO);
                }
        } catch (Exception e) {
            // TODO: handle exception
