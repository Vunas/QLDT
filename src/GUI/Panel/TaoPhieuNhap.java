...
public class TaoPhieuNhap extends JPanel {
    JPanel left, right, luachonsanpham, thongtinsanpham, thongtinsanpham_top, thongtinsanpham_bottom,
            ...
            thongtinsanpham_top_chgt, thongtinsanpham_top_imeisl, thongtinsanpham_bottom_button;
    ...
    public void themchitietphieunhap() {
        for (int row = 0; row < sanphamdathemTable.getRowCount(); row++) {
            ...
            int soluongMoi = Integer.parseInt(sanphamdathemTable.getValueAt(row, 6).toString())
