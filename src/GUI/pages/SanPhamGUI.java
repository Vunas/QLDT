...
//        // Lấy dữ liệu từ BLL
//        String[] columnNames = { "Mã SP", "Tên SP", "Image", "Số Lượng", "Giá Nhập", "Giá Bán", "Màu Sắc", "Thương Hiệu", "Ram", "Rom", "Chip", "Thời Gian BH"};
//        DefaultTableModel model = new DefaultTableModel(columnNames, 0);
//        NumberFormat formatter = NumberFormat.getCurrencyInstance(new Locale("vi", "VN"));
//        // Thêm dữ liệu vào bảng
//        for (SanPhamDTO sp : sanPhamList) {   
//            Object[] rowData = { sp.getMaSP(), sp.getTenSP(), sp.getImg(), sp.getSoLuong(),formatter.format(sp.getGiaNhap()),
//                formatter.format(sp.getGiaBan()), sp.getMauSac(), sp.getThuongHieu(),sp.getRam(),sp.getRom(),sp.getChip(),sp.getThoiGianBaoHanh()};
...
//    }
    private void loadData(List<SanPhamDTO> sanPhamList) {
        ...
        String[] columnNames = { "Mã SP", "Tên SP", "Image", "Hidden Path", "Số Lượng", "Giá Nhập", "Giá Bán", "Màu Sắc", "Thương Hiệu", "Ram", "Rom", "Chip", "Thời Gian BH" };
