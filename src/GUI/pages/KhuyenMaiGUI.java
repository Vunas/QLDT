...
public class KhuyenMaiGUI extends JPanel {
    ...
    public void loadData(List<KhuyenMaiDTO> khuyenMaiList) {
        String[] columnName = { "Mã Khuyến Mãi", "Tên Khuyến Mãi", "Số Lượng", "Ngày Bắt Đầu", "Ngày Kết Thúc", "Áp Dụng Cho Hóa Đơn Từ",
                "Giá Trị", "Hình Thức" };
    ...
    private void chucnang() {
        ...
        btn[1].addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                KhuyenMaiDTO khuyenMaiDTO = new KhuyenMaiDTO(maKM, tenKM, soLuong, ngayBD, ngayKT, apDungChoHoaDonTu, giaTri,
                    hinhThuc);
        ...
        btn[2].addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int maKM = (int) tbl.getValueAt(selectedRow, 0);                            
                int confirm = JOptionPane.showConfirmDialog(null, "Bạn Có Chắc Xóa Khuyến Mãi Này Không", "Xóa Khuyến Mãi", JOptionPane.YES_NO_OPTION);
