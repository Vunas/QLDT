...
(1, 2, NULL, 2, 1, 26000000, 1),
(2, 3, 2, 2, 2, 26000000, 1),
(3, 4, NULL, 8, 1, 22000000, 1),
(4, 4, NULL, 6, 1, 14000000, 1),
(5, 5, NULL, 9, 1, 25000000, 1),
(6, 5, NULL, 8, 1, 22000000, 1),
(7, 6, NULL, 10, 1, 10000000, 1),
(8, 7, NULL, 10, 1, 10000000, 1),
(9, 8, NULL, 8, 3, 22000000, 1),
(10, 9, NULL, 8, 2, 22000000, 1),
(11, 10, NULL, 2, 1, 26000000, 1),
(12, 10, NULL, 8, 1, 22000000, 1),
(13, 11, 1, 6, 1, 14000000, 1),
(14, 12, NULL, 2, 1, 26000000, 1),
(15, 13, 3, 9, 1, 25000000, 1);
...
INSERT INTO `ctsanpham` (`maimei`, `masanpham`, `maphieunhap`, `mahoadon`, `maPhieuBH`, `tinhtrang`, `trangthai`) VALUES
('111222111333000', 10, 1, 6, 0, 1, 1),
('111222111333001', 10, 1, 7, 0, 1, 1),
('111222333444500', 9, 1, 5, 0, 1, 1),
('111222333444501', 9, 1, NULL, 0, 0, 1),
('111222333444502', 9, 1, 13, 3, 1, 1),
('111222333444503', 9, 1, NULL, 0, 0, 1),
('111222333444504', 9, 1, NULL, 0, 0, 1),
('111222333444505', 9, 1, NULL, 0, 0, 1),
('111222333444506', 9, 1, NULL, 0, 0, 1),
('111222333444507', 9, 1, NULL, 0, 0, 1),
('111222333444508', 9, 1, NULL, 0, 0, 1),
('111222333444509', 9, 1, NULL, 0, 0, 1),
('111222333444510', 9, 1, NULL, 0, 0, 1),
('111222333444511', 9, 1, NULL, 0, 0, 1),
('111222333444512', 9, 1, NULL, 0, 0, 1),
('111222333444513', 9, 1, NULL, 0, 0, 1),
('111222333444514', 9, 1, NULL, 0, 0, 1),
('111222333444515', 9, 1, NULL, 0, 0, 1),
('111222333444516', 9, 1, NULL, 0, 0, 1),
('111222333444517', 9, 1, NULL, 0, 0, 1),
('111222333444518', 9, 1, NULL, 0, 0, 1),
('111222333444519', 9, 1, NULL, 0, 0, 1),
('111222333444520', 9, 1, NULL, 0, 0, 1),
('111222333444521', 9, 1, NULL, 0, 0, 1),
('111222333444522', 9, 1, NULL, 0, 0, 1),
('123123123123100', 6, 2, 11, 1, 1, 1),
('123123123123101', 6, 2, NULL, 0, 0, 1),
('123123123123102', 6, 2, 4, 0, 1, 1),
('123123123123103', 6, 2, NULL, 0, 0, 1),
('123123123123104', 6, 2, NULL, 0, 0, 1),
('123123123123105', 6, 2, NULL, 0, 0, 1),
('123123123123311', 8, 3, 10, 0, 1, 1),
('123123123123312', 8, 3, 9, 0, 1, 1),
('123123123123313', 8, 3, 8, 0, 1, 1),
('123123123123314', 8, 3, 8, 0, 1, 1),
('123123123123315', 8, 3, NULL, 0, 0, 1),
('123123123123316', 8, 3, NULL, 0, 0, 1),
('123123123123317', 8, 3, NULL, 0, 0, 1),
('123123123123318', 8, 3, NULL, 0, 0, 1),
('123123123123319', 8, 3, NULL, 0, 0, 1),
('123123123123320', 8, 3, NULL, 0, 0, 1),
('123123123123321', 8, 3, NULL, 0, 0, 1),
('123123123123322', 8, 3, NULL, 0, 0, 1),
('123123123123323', 8, 3, NULL, 0, 0, 1),
('123123123123324', 8, 3, NULL, 0, 0, 1),
('123123123123325', 8, 3, NULL, 0, 0, 1),
('123123123123326', 8, 3, NULL, 0, 0, 1),
('123123123123327', 8, 3, NULL, 0, 0, 1),
('123123123123328', 8, 3, NULL, 0, 0, 1),
('123123123123329', 8, 3, NULL, 0, 0, 1),
('123123123123330', 8, 3, NULL, 0, 0, 1),
('123123123123331', 8, 3, NULL, 0, 0, 1),
('123123123123332', 8, 3, NULL, 0, 0, 1),
('999111222333100', 2, 2, 10, 0, 1, 1),
('999111222333101', 2, 2, 3, 2, 1, 1),
('999111222333102', 2, 2, NULL, 0, 0, 1),
('999111222333103', 2, 2, NULL, 0, 0, 1),
('999111222333104', 2, 2, NULL, 0, 0, 1),
('999111222333105', 2, 2, NULL, 0, 0, 1),
('999111222333106', 2, 2, NULL, 0, 0, 1),
('999111222333107', 2, 2, NULL, 0, 0, 1),
('999111222333108', 2, 2, NULL, 0, 0, 1),
('999111222333109', 2, 2, NULL, 0, 0, 1),
('999111222333110', 2, 2, 12, 0, 1, 1),
('999111222333111', 2, 2, NULL, 0, 0, 1);
...
(1, '2025-04-23', 1, 1, 0, 1),
(2, '2025-04-23', 1, 1, 0, 1),
(3, '2025-04-23', 1, 1, 0, 1),
(4, '2025-04-23', 7, 1, 0, 1),
(5, '2025-04-23', 1, 1, 0, 1),
(6, '2023-04-12', 1, 1, 0, 1),
(7, '2025-04-24', 1, 1, 0, 1),
(8, '2025-04-24', 1, 1, 0, 1),
(9, '2025-04-24', 1, 1, 0, 1),
(10, '2025-04-24', 1, 1, 0, 1),
(11, '2025-04-24', 1, 1, 0, 1),
(12, '2025-04-24', 1, 1, 0, 1),
(13, '2025-04-27', 1, 1, 0, 1);
...
(1, 'iPhone 14 Pro Max', 'src/resources/img/phone7.jpeg', 10, 25000000, 28000000, 'Đen', 'Apple', 6, 128, 'A16 Bionic', 12, 1),
(2, 'Samsung Galaxy S23 Ultra', 'src/resources/img/phone4.jpeg', 100, 23000000, 26000000, 'Xanh', 'Samsung', 12, 256, 'Snapdragon 8 Gen 2', 12, 1),
...
(6, 'Realme GT 3', 'src/resources/img/phone2.jpeg', 16, 12000000, 14000000, 'Tím', 'Realme', 8, 256, 'Snapdragon 8+ Gen 1', 12, 1),
(7, 'Google Pixel 7 Pro', 'src/resources/img/phone9.jpeg', 6, 21000000, 24000000, 'Xám', 'Google', 12, 256, 'Google Tensor G2', 12, 1),
(8, 'iPhone 13', 'src/resources/img/phone1.jpeg', 16, 19000000, 22000000, 'Xanh', 'Apple', 4, 128, 'A15 Bionic', 12, 1),
(9, 'Samsung Galaxy Z Flip4', 'src/resources/img/phone3.jpeg', 10, 22000000, 25000000, 'Yellow', 'Apple', 64, 256, 'Snapdragon 8+ Gen 1', 24, 1),
(10, 'Xiaomi Redmi Note 12 Pro', 'src/resources/img/phone4.jpg', 25, 8000000, 10000000, 'Xanh dương', 'Xiaomi', 8, 128, 'Dimensity 1080', 12, 0);
...
ALTER TABLE `phieusuachua`
  ADD PRIMARY KEY (`maPhieuSC`),
  ADD KEY `phieusuachua_ibfk_1` (`maPhieuBH`);
...
--
-- AUTO_INCREMENT for table `chitietphieubaohanh`
--
ALTER TABLE `chitietphieubaohanh`
  MODIFY `MaChiTiet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `phieubaohanh`
  MODIFY `maPhieuBH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `phieusuachua`
  MODIFY `maPhieuSC` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `chitietphieubaohanh`
  ADD CONSTRAINT `chitietphieubaohanh_ibfk_1` FOREIGN KEY (`MaPhieuBH`) REFERENCES `phieubaohanh` (`maPhieuBH`),
  ADD CONSTRAINT `chitietphieubaohanh_ibfk_2` FOREIGN KEY (`MaSanPham`) REFERENCES `sanpham` (`maSP`);
...
--
ALTER TABLE `phieubaohanh`
  ADD CONSTRAINT `phieubaohanh_ibfk_1` FOREIGN KEY (`maKhachHang`) REFERENCES `khach_hang` (`maKH`);
...
--
ALTER TABLE `phieusuachua`
  ADD CONSTRAINT `phieusuachua_ibfk_1` FOREIGN KEY (`maPhieuBH`) REFERENCES `phieubaohanh` (`maPhieuBH`);
